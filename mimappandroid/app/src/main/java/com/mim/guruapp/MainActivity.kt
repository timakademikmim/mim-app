...
import com.mim.guruapp.alarm.LessonNotificationNotifier
...
class MainActivity : ComponentActivity() {
    ...
    setContent {
      MimGuruTheme(themeMode = AppThemeMode.fromCode(viewModel.uiState.themeModeCode)) {
        GuruAppRoot(
          ...
          onSelectActiveRole = viewModel::selectActiveRole,
          ...
          onLoadTeachingSession = viewModel::loadTeachingSession,
          onSaveTeachingSession = viewModel::saveTeachingSession,
          onLoadMapelQuestions = viewModel::loadMapelQuestionJson,
          onSaveMapelQuestions = viewModel::saveMapelQuestionJson,
          onLoadMapelRaporDescriptions = viewModel::loadMapelRaporDescriptionJson,
          onSaveMapelRaporDescriptions = viewModel::saveMapelRaporDescriptionJson,
          onLoadExamQuestions = viewModel::loadExamQuestionSnapshot,
          onSaveExamQuestions = viewModel::saveExamQuestionJson,
          onLoadAiTokenBalance = viewModel::loadAiTokenBalance,
          onGenerateAiContent = viewModel::generateAiContent,
          onLoadAdminAcademicCalendar = viewModel::loadAdminAcademicCalendar,
          onSaveAdminAcademicCalendarEvent = viewModel::saveAdminAcademicCalendarEvent,
          onDeleteAdminAcademicCalendarEvent = viewModel::deleteAdminAcademicCalendarEvent,
          onLoadAdminAcademicPeriods = viewModel::loadAdminAcademicPeriods,
          onSaveAdminAcademicYear = viewModel::saveAdminAcademicYear,
          onSaveAdminSemester = viewModel::saveAdminSemester,
          onSetActiveAdminAcademicYear = viewModel::setActiveAdminAcademicYear,
          onSetActiveAdminSemester = viewModel::setActiveAdminSemester,
          onLoadAdminEmployees = viewModel::loadAdminEmployees,
          onSaveAdminEmployee = viewModel::saveAdminEmployee,
          onLoadAdminSchoolProfile = viewModel::loadAdminSchoolProfile,
          onSaveAdminSchoolProfile = viewModel::saveAdminSchoolProfile,
          onLoadAdminKelas = viewModel::loadAdminKelas,
          onSaveAdminKelas = viewModel::saveAdminKelas,
          onAssignAdminKelasStudents = viewModel::assignAdminKelasStudents,
          onLoadAdminMapel = viewModel::loadAdminMapel,
          onSaveAdminMapelSubject = viewModel::saveAdminMapelSubject,
          onSaveAdminMapelDistribution = viewModel::saveAdminMapelDistribution,
          onLoadAdminTeachingSchedule = viewModel::loadAdminTeachingSchedule,
          onSaveAdminTeachingSchedule = viewModel::saveAdminTeachingSchedule,
          onDeleteAdminTeachingSchedule = viewModel::deleteAdminTeachingSchedule,
          onSaveAdminLessonSlot = viewModel::saveAdminLessonSlot,
          onDeleteAdminLessonSlot = viewModel::deleteAdminLessonSlot,
          onLoadAdminSantri = viewModel::loadAdminSantri,
          onSaveAdminSantri = viewModel::saveAdminSantri,
          onPromoteAdminSantri = viewModel::promoteAdminSantri,
          onGraduateAdminSantri = viewModel::graduateAdminSantri,
          onSaveProfile = viewModel::saveProfile,
          onChangePassword = viewModel::changeOwnPassword,
          onLinkGoogleAccount = viewModel::startGoogleLink,
  ...
  private fun requestNotificationPermissionIfNeeded() {
    ...
    val permissionPrefs = getSharedPreferences("mim_guru_permissions", MODE_PRIVATE)
    val alreadyRequested = permissionPrefs.getBoolean("lesson_notifications_requested", false)
    if (!granted && !alreadyRequested) {
      permissionPrefs.edit().putBoolean("lesson_notifications_requested", true).apply()
